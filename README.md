...
- Credentials (`ODESLI_API_KEY`, `GOOGLE_SERVICE_API_KEY` for YouTube,
  `GOOGLE_GEMINI_API_KEY` for Gemini, SSH deploy keys, etc.) live in an
  untracked `.env` at the repo root — never in git.
