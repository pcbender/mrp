...
## Corpus Check
- 2796 files · ~1,845,960,741 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17685 nodes · 24467 edges · 2709 communities (2252 shown, 457 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a62d45f`
...
## Communities (2709 total, 457 thin omitted)
...
Cohesion: 0.11
Nodes (28): staticUrl(), cloneRouteMap(), getCloneByPath(), getCloneHeadForPath(), getCloneHeadManifest(), getClonePages(), getClonePosts(), isNonHttpUrl() (+20 more)
...
Cohesion: 0.10
Nodes (19): Architecture, Desired Result, MRP-111 - WXR Parser And Inventory, MRP-112 - Clone Content Model, MRP-113 - Generate Clone Records From WXR, MRP-114 - WordPress Asset Mirror, MRP-115 - Head Dependency Extraction, MRP-116 - Astro Clone Renderer (+11 more)
...
Cohesion: 0.15
Nodes (13): type, type, type, properties, apple_music, bandcamp, landing_page, soundcloud (+5 more)

### Community 342 - "Community 342"
Cohesion: 0.18
Nodes (12): type, additionalProperties, type, $defs, credits, links, song, additionalProperties (+4 more)
...
Cohesion: 0.22
Nodes (9): properties, type, type, type, mastering, primary_artist, producer, songwriter (+1 more)
...
Cohesion: 0.13
Nodes (31): ArgumentParser, add_common_command_options(), add_global_options(), build_parser(), emit(), main(), placeholder_result(), base_result() (+23 more)
...
Cohesion: 0.18
Nodes (10): ../components/Footer.astro, ../components/Header.astro, ../components/SEOHead.astro, ../../layouts/BaseLayout.astro, ../../layouts/CloneLayout.astro, head, inlineStyles, preloads (+2 more)

### Community 1728 - "Community 1728"
Cohesion: 0.22
Nodes (7): ../../lib/content.js, getArtistById(), getMigratedPosts(), migratedDescription(), migratedPostRouteEntries(), GET(), posts

### Community 1729 - "Community 1729"
Cohesion: 0.22
Nodes (8): artist, clone, getStaticPaths(), releases, ../../components/ReleaseCard.astro, cloneDescription(), releaseCoverUrl(), releases
...
Cohesion: 0.47
Nodes (8): getAllReleases(), getArtists(), getMigratedPages(), getMigratedRoutes(), getVisibleReleases(), migratedRouteMap(), readRecords(), GET()

### Community 1755 - "Community 1755"
Cohesion: 0.29
Nodes (6): artists, ../components/ArtistCard.astro, artistReleaseCount(), latestRelease(), artists, release
...
Cohesion: 0.29
Nodes (6): ../../components/StreamingLinks.astro, getReleaseBySlug(), streamingLinks(), artist, getStaticPaths(), release
...
Cohesion: 0.70
Nodes (4): clonePathParam(), getCloneRoutes(), migratedPathParam(), getStaticPaths()
...
Cohesion: 0.40
Nodes (9): comparison_repo(), page_html(), CompletedProcess, Path, route_file(), run_mrp(), test_clone_compare_missing_marker_fails(), test_clone_compare_reports_representative_page_matches() (+1 more)
...
## Knowledge Gaps
- **548 isolated node(s):** `codeToStatusMap`, `manifest`, `Namespace`, `Path`, `$schema` (+543 more)
...
- **Why does `verify_target()` connect `Community 9` to `Community 2088`, `Community 738`, `Community 2131`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `stage_build()` connect `Community 2088` to `Community 738`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 738` to `Community 737`, `Community 993`, `Community 1702`, `Community 2088`, `Community 745`, `Community 744`, `Community 9`, `Community 205`, `Community 943`, `Community 752`, `Community 2544`, `Community 2131`, `Community 22`, `Community 155`, `Community 2525`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
