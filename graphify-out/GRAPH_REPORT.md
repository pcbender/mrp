...
Cohesion: 0.15
Nodes (14): ../components/Footer.astro, ../components/Header.astro, ../components/SEOHead.astro, ../../layouts/BaseLayout.astro, ../layouts/CloneLayout.astro, head, inlineStyles, preloads (+6 more)
...
### Community 52 - "[slug]"
Cohesion: 0.10
Nodes (17): absolutePublicUrl(), getArtistById(), getReleaseBySlug(), getTrackBySlug(), publicMusicVideo(), GET(), allTracks, artist (+9 more)
...
Cohesion: 0.33
Nodes (5): _contain_env_mutations(), isolated_repo(), Path, Restore os.environ after every test.      app/critic and app/promoter both call, A filesystem copy of the real repo for e2e tests that exercise the full     CLI
...
Cohesion: 0.33
Nodes (6): generator_version, key, seed, source, traces, chorus-3
...
Cohesion: 0.33
Nodes (6): generator_version, key, seed, source, traces, instrumental-2
...
Cohesion: 0.33
Nodes (6): generator_version, key, seed, source, traces, pre-chorus-3
...
Cohesion: 0.33
Nodes (6): generator_version, key, seed, source, traces, fade-out
